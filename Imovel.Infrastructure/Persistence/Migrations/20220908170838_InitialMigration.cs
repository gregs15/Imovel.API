        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quartos = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Banheiros = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CEP = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Estado = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Cidade = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Bairro = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AreaTotal = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AreaConstruida = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VagasGaragem = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_Users_IdCorretor",
                        column: x => x.IdCorretor,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
